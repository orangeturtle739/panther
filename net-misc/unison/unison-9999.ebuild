...
COMMIT="d860a697fcd507cabae25dfded22dd03f5a6d920"
MV="unison-2.48.3"
SRC_URI="https://github.com/bcpierce00/unison/archive/${COMMIT}.zip
	doc? ( http://www.cis.upenn.edu/~bcpierce/unison/download/releases/${MV}/${MV}-manual.pdf
		http://www.cis.upenn.edu/~bcpierce/unison/download/releases/${MV}/${MV}-manual.html )"

# Change the source directory from the default directory
S="${WORKDIR}/unison-${COMMIT}"
